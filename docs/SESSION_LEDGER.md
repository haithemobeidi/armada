...
- [ ] L-1 (2026-09-05) Rebase `odin3-tuning` onto `upstream/main` — 3 commits behind after the user's OTA to `20260904.14230df`; user-approved action at a quiet point (D-2), suggested before B1 work starts.
